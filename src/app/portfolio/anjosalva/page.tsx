        ...
        <main className="container mx-auto mt-20 px-4 py-12">
            ...
            <div>
                ...
                <h1 className="text-4xl font-bold mb-6">
                    Anjo Salva | Brigada de Emergência{" "}
                </h1>
                ...
                <p className="text-muted-foreground mb-6">
                    ...
                    Anjo Salva, uma empresa especializada em
                    atendimento de emergência para eventos de qualquer natureza. O site apresenta a empresa e os serviços oferecidos de forma atraente, em conjunto com uma barra de navegação para facilitar a experiência do usuário.
                </p>
                ...
                <ul className="list-disc list-inside text-muted-foreground mb-6">
                    ...
                    <li>Seção de contato para se comunicar diretamente com a empresa pelo email</li>
                </ul>

                <Link
                    href="https://anjo-salva.vercel.app"
                    target="_blank"
