        ...
        <main className="container mx-auto mt-20 px-4 py-12">
            ...
            <div>
                ...
                <p className="text-muted-foreground mb-6">
                    A página criada é um portfólio profissional para o filmmaker autônomo Zafalon. Além de contar com um design elegante e minimalista, apresenta o profissional e disponibiliza todos os meios de contato oferecidos. Para a apresentação dos projetos do portfólio, é feita a exibição dos trabalhos publicados no Instagram, disponibilizando uma plataforma de login com autorização de fácil utilização para adicionar, remover e gerenciar os projetos exibidos.
                ...
                <ul className="list-disc list-inside text-muted-foreground mb-6">
                    ...
                    <li>Login para o usuário administrador</li>
                    <li>Dashboard de gerenciamento dos projetos</li>
                </ul>

                <Link
                    href="https://zafaloon-filmmaker.vercel.app"
                    target="_blank"
