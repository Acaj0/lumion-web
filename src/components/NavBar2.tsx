  ...
  return (
    ...
    >
      ...
      <nav className="ml-auto flex gap-4 sm:gap-6">
        <Link
          href="/portfolio"
          className={`text-lg font-medium hover:underline underline-offset-4 md:flex hidden transition-all duration-500 ease-in-out text-black`}
          prefetch={false}
        >
          Portfólio
        </Link>
