...
export default function ContactButton() {
    ...
    return (
        <Link
            ref={buttonRef}
            href="https://api.whatsapp.com/send?phone=5571982471477&text=Ol%C3%A1!%20Vim%20pelo%20site%20da%20Lumen%20e%20gostaria%20de%20conversar%20sobre%20um%20projeto."
            target="_blank"
            style={{ bottom: `${buttonPosition}px` }}
            className={`${isVisible ? "" : "hidden"} fixed right-4 z-50 flex items-center justify-center rounded-full bg-sky-700 shadow-lg text-white transition-all duration-300 ease-in-out hover:bg-sky-600 hover:shadow-xl ${
        ...
        >
            ...
            {isExpanded && <span className="ml-2 text-sm font-medium whitespace-nowrap">Fale conosco no WhatsApp</span>}
        </Link>
    )
}